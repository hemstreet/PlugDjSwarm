...
var swarm = {
    ...
    generateBots: function(data) {
        ...
        _(this.numBots).times(function(i) {
            ...
            console.log('creating bot #', i, data[i].email,data[i].password );
            if(data[i] == undefined) {
    ...
    setupBotListeners: function() {
        _.each(this.bots, function(bot) {
            bot.on('chat', function(data) {
                ...
                //if (data.message.indexOf('props') > -1) {
                //    bot.woot();
                //    bot.sendChat('People love this shit');
                //}
                ...
                if(data.raw.un == this.masterAccount) {
                    ...
                    if(message.charAt(0) == "$") {
                        ...
                        {
                            this.sendChat(bot, 'Invalid Command');
                        }
                    }
                }
            }.bind(this));
